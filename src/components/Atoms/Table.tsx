      ...
      <table className="min-w-full border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            <th className="px-4 py-2 text-left text-sm font-semibold text-gray-700">Cultural Influences on RE activities for {country}</th>
            <th className="px-4 py-2 text-left text-sm font-semibold text-gray-700">Confidence Level</th>
          </tr>
        </thead>
        <tbody>
          {data.map((item, index) => (
